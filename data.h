...
char* ler_arquivo(FILE *arquivo, char a[50], char* tab);                        //fun��o que l� palavra do arquivo de entrada
DicLDE* encontraNoDicOrdenado(DicLDE *D, char linha[50], int *comp);            //fun��o que encontra palavra dada no dicion�rio ordenado
